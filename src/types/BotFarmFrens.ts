...
export interface BotFarmFrensInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "MintBFF(address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MintBFF"): EventFragment;
...
export type MintBFFEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  { minter: string; mintAmount: BigNumber; fee: BigNumber }
>;

export type MintBFFEventFilter = TypedEventFilter<MintBFFEvent>;
...
export interface BotFarmFrens extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BotFarmFrensInterface;
  ...
  filters: {
    ...
    "MintBFF(address,uint256,uint256)"(
      minter?: string | null,
      mintAmount?: null,
      fee?: null
    ): MintBFFEventFilter;
